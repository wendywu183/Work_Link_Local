...
public class ImMessageBottomOptionAdapter extends BaseAdapter {

    private Context mCtx;
    private ArrayList<ChatOpResPair> mOptionPairList;

    public ImMessageBottomOptionAdapter(Context ctx) {
        mCtx = ctx;
        mOptionPairList = new ArrayList<ChatOpResPair>();
        String[] opTitles = mCtx.getResources().getStringArray(R.array.im_msg_bottom_op_titles);
        TypedArray icons = mCtx.getResources().obtainTypedArray(R.array.im_msg_bottom_op_icons);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHoder.rightLine = convertView.findViewById(R.id.v_item_rightline);
            viewHoder.bottomLine = convertView.findViewById(R.id.v_item_bottomline);
        ...
        viewHoder.bottomLine.setVisibility(View.GONE);
